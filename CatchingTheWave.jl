...
# ╔═╡ 210128f4-bbdd-4d4a-afc3-729f725766b2
using ModelingToolkit, MethodOfLines, OrdinaryDiffEq, DomainSets

# ╔═╡ deca48bf-b345-4adb-91bf-f20e1bfa24fe
begin
	@parameters x y t
	@variables S(..) ρ(..)
	Dt = Differential(t)
...
# ╔═╡ 562dc3a0-84bf-11ee-3734-090d425a94fe
begin
	# Initial Conditions
	S0(x,y,t) = (y*(1-y))^(3/2) 
	ρ0(x,y,t) = (x*(1-x))^(3/2)
...
# ╔═╡ 03a91318-4bf7-4842-b82a-3b09b3ce9e36
begin
	eq = [Dt(S(x,y,t)) ~ α*∇²(S(x,y,t)) - β*S(x,y,t) + γ*S(x,y,t)^2 - δ*S(x,y,t)^3,
	       Dt(ρ(x,y,t)) ~ η*∇²(ρ(x,y,t)) + χ*∇²(S(x,y,t))*ρ(x,y,t)+ χ*Div(S(x,y,t),ρ(x,y,t))]
end

# ╔═╡ a9ba78d1-7c6c-47fe-9410-2cec09a48c7d
begin
...
# ╔═╡ e77d3dce-11b9-4d19-aff1-e3b103fa7169
begin	
	# Periodic BCs
	bcs = [S(x,y,0) ~ S0(x,y,0),
	       S(0,y,t) ~ S(1,y,t),
	       S(x,0,t) ~ S(x,1,t),
	...
	@named pdesys = PDESystem(eq,bcs,domains,[x,y,t],[S(x,y,t),ρ(x,y,t)])
end

# ╔═╡ cf77147b-1f88-43db-a0b6-9be2c7c458ac
begin
	N = 32
...
# ╔═╡ d50baa32-da77-488f-9afc-d3e775d5c13a
begin
...
# ╔═╡ ad22132f-fefa-41e2-bf5b-02d37ebd9f59
# begin
# 	println("Solve:")
# 	@time sol = solve(prob, TRBDF2(), saveat=0.1)
# end

# ╔═╡ 6e2197b7-5e8e-40cb-82d0-4da11963d1f0
# begin
# 	discrete_x = sol[x]
# 	discrete_y = sol[y]
# 	discrete_t = sol[t]
...
# ╔═╡ 6b841d1a-4017-4960-a685-d8ec295d95e8
# begin
# 	using Plots
...
# ╔═╡ 87c9bde7-a568-4c20-a563-9f6f31c677ef


# ╔═╡ 9972c7b5-16db-4309-b801-8ca5f8476777


# ╔═╡ 5dbc90d1-8628-4683-abbe-96b094375f02


# ╔═╡ c6a8e758-f2b1-4274-a0b4-670e4799f9be


# ╔═╡ b371cd0b-3c36-4305-8c18-553f641c0adf


# ╔═╡ 28154cae-b0ea-4c30-bf77-ac354daed2e0
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "b9e7ffa5a7bd9f55ec1320689e3c8b84dd195856"
