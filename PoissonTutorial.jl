...
# ╔═╡ ccf8607a-2980-491d-8cf3-2ba1cb118e69
# Import Packages
begin
...
# ╔═╡ ce922b77-98fe-41f4-b100-67a94b2f13b5
begin
	@parameters x y
	@variables u(..)
...
# ╔═╡ 055a695a-0a2b-4561-b570-16c5787b87c7
begin
	# Neural network
...
# ╔═╡ 3a61397f-f52d-43b4-b8db-dd4173863bbf
begin
	# Discretization
	dx = 0.05
...
# ╔═╡ 9978a66f-f390-49bd-a6d2-a55cd3a382a5
begin
	@named pde_system = PDESystem(eq, bcs, domains, [x, y], [u(x, y)])
	prob = discretize(pde_system, discretization)
end

# ╔═╡ 1d29f34b-23c8-48bf-9219-0b9fbaba3ecf
begin
	#Optimizer
...
# ╔═╡ 736961e9-e0ea-4623-aeb2-c42fdfb631c7
begin
...
# ╔═╡ f9927e05-ca74-4ad3-b36a-45ac39792fe3


# ╔═╡ a03f7566-db93-46a5-aedd-92ec528b65bb


# ╔═╡ 9667b5ba-8d90-4f2e-a552-7ba07c977c29


# ╔═╡ 9b659c7d-bb16-4b4a-b339-cc6f9d8f078f


# ╔═╡ 51d80f8f-c03c-45f9-b1e5-aeac44a8d102


# ╔═╡ f49a16b0-4eb9-4c03-82b9-d8e2979b0631


# ╔═╡ c82befc7-6d39-42da-a905-b76b459a0c56


# ╔═╡ 42b14c9c-5bc4-49e1-8f7e-021764410244
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "a9359c37c2ba65b4d0841800f7d037dfdc9c680b"
