...
# ╔═╡ 66430fd0-84e8-11ee-03d9-ed5af774ba3d
begin
...
# ╔═╡ ad487353-1582-41ed-98ca-2aed2f9e35e4
begin
	@parameters x
	@variables p(..)
	Dx = Differential(x)
...
# ╔═╡ 7a3c1497-4a5a-4978-82ea-c26c545c58cf
begin
	# Neural network
	inn = 18
	...
	res = Optimization.solve(prob, LBFGS(), callback = cb_, maxiters = 1000)
	prob = remake(prob, u0 = res.u)
	res = Optimization.solve(prob, BFGS(), callback = cb_, maxiters = 2000)

end

# ╔═╡ 5936be58-f407-427a-8d2e-b40494fc5522
begin
	using Plots
...
# ╔═╡ 39095024-7971-488d-9b0c-4e3c04ad3b3c


# ╔═╡ 32820df8-5b98-490c-aaed-53f76b1de6f4


# ╔═╡ 0aecd215-60ea-4eeb-8bf4-c98709c55b74


# ╔═╡ 937be882-546d-4301-b3d8-3b2885d4e34d


# ╔═╡ 2688cb87-5449-4331-bd17-3c95d9979485


# ╔═╡ 746172e9-4ce0-4702-8077-4d2c4c7c04b8


# ╔═╡ f8b9f2b7-837d-4456-8277-adafd5217faf


# ╔═╡ 8b91b472-b037-4da0-9e01-012333fa013b
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "2dd55185ee1d68f3b545153b6840c9c7e8aea27d"
