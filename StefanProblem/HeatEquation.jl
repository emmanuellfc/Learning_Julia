...
# ╔═╡ 54067bf1-89a5-49e6-a82a-42ac494b1103
using MovingBoundaryProblems1D 

# ╔═╡ 0f6c1c8a-87cb-425b-a9c1-f78455dc9b50
using CairoMakie

# ╔═╡ 847f6712-8a21-11ee-1787-3d9a744912b8
md"""
# Heat Equation
"""

# ╔═╡ 4f5704ae-f9b8-4d75-abaf-dd340d358e52
begin
...
# ╔═╡ 6c5a8a8b-3fbf-4a21-9d1e-3ad0d53c80ab
begin
...
# ╔═╡ 295be601-7e61-47f1-ab41-618e6b95bd75
begin
...
# ╔═╡ 394ec2c5-f4d6-47b8-8a6c-04e8df087cda
begin
	# Define the problem
...
# ╔═╡ 679d0310-da55-42af-a1f6-e6fb2b9740e1
begin
	using OrdinaryDiffEq, LinearSolve
	sol = solve(prob, TRBDF2(linsolve=KLUFactorization()), saveat=0.1)
end

# ╔═╡ c35dec54-ab4d-4ef9-8265-993682c9a166
scaled_mesh = scaled_mesh_points(prob, sol)

# ╔═╡ 4ba353a3-fb09-41a0-b652-38b6476fb78b
begin
...
# ╔═╡ df54fb72-72cd-42b1-8378-f93f7470a6a0
fig

# ╔═╡ 023461d1-cbe5-4e37-9f5f-184d1d69a1ab
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "ad57ed48bac4c5b2f63ed6016039f3da40a11104"
