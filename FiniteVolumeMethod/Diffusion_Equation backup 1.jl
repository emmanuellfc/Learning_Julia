...
# ╔═╡ b82879fa-7025-48a4-80d9-d63712559280
using CairoMakie
...
# ╔═╡ 66576177-9fcc-4053-97dd-bbd91ed852a4
...
# ╔═╡ ec5cd3d6-8110-40b3-af25-35d6a0ae57a4
begin
	f = (x, y) -> y ≤ 1.0 ? 50.0 : 0.0 # Ternary Operator
	initial_condition = [f(x, y) for (x, y) in each_point(tri)]
	D = (x, y, t, u, p) -> 1 / 9
end

# ╔═╡ 9fc5bab6-db7c-4441-9c9c-7719c660574e
begin
	final_time = 0.5
	prob = FVMProblem(mesh, BCs; diffusion_function=D, initial_condition, final_time)
end

# ╔═╡ 29105e75-7e83-4f15-8a92-425020a60e84
begin
	using DifferentialEquations
	sol = solve(prob, saveat=0.05)
end

# ╔═╡ 30af784a-3e76-41d7-b232-ea6b792f1c18


# ╔═╡ 7dc90842-a96b-4229-9e9b-9d790dee627f


# ╔═╡ d0c34a5e-497e-4fa0-89f2-e993dd024f28


# ╔═╡ cd8fe579-9b76-45e6-a5e3-9b887f0239e1


# ╔═╡ ad384162-2d4a-4bf4-b83c-ae02945e9570


# ╔═╡ a59f61df-0815-4a08-9d17-36f5cf12c646


# ╔═╡ ccb15680-87d4-46a8-aa63-af7708a1bd71


# ╔═╡ 089e0d2e-dd76-4d70-8151-0823fe77a31c
...
[compat]
CairoMakie = "~0.10.12"
DelaunayTriangulation = "~0.8.10"
DifferentialEquations = "~7.11.0"
FiniteVolumeMethod = "~1.1.2"
"""
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "af4516ed48f386936fe66453b5189a576a312409"
...
[[deps.ChunkSplitters]]
deps = ["TestItems"]
git-tree-sha1 = "a0d0d0372dbc00735bce1976928094acedfdbf8e"
...
[[deps.FiniteVolumeMethod]]
deps = ["ChunkSplitters", "CommonSolve", "DelaunayTriangulation", "LinearAlgebra", "PreallocationTools", "PrecompileTools", "SciMLBase", "SparseArrays"]
git-tree-sha1 = "4a000442e807c67821f7ef07afed9e447e71b2c7"
